...
export default async function ContactPage() {
  ...
  return (
    <div className="bg-white min-h-screen pb-24">
      ...
      {/* Main Content */}
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mt-2 md:mt-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-8">
          
          {/* Left Card: Form */}
          <div className="bg-[#F8F9FA] rounded-[1.5rem] md:rounded-[2rem] p-5 md:p-12">
            <ContactForm />
          </div>

          {/* Right Card: Contact Info */}
          <div className="bg-[#F8F9FA] rounded-[1.5rem] md:rounded-[2rem] p-5 md:p-12 flex flex-col">
        ...
        {/* Map Section */}
        <div className="mt-6 md:mt-12 rounded-[1.5rem] md:rounded-[2rem] overflow-hidden shadow-sm border border-gray-200 h-[250px] md:h-[400px] w-full">
          <iframe 
            src={
